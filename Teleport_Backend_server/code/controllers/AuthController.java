...
//  }
  ...
  public ResponseEntity<?> signUp(@RequestBody @Valid SignUpDto data) {
    ...
    return ResponseEntity.status(HttpStatus.CREATED).body(new JwtDto(accessToken, user.getUsername(), subscriptionType,role));
  }
  ...
  public ResponseEntity<JwtDto> signIn(@RequestBody @Valid SignInDto data) {
    ...
    return ResponseEntity.ok(new JwtDto(accessToken, data.userName(), subscriptionType,role));
  }
